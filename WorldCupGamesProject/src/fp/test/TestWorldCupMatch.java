...
public class TestWorldCupMatch {
	...
	private static void welcome() {
		...
		System.out.println("\n  Hello, this is my project about all the World Cup matches of football's history."
				...
				+ "\n	15. Get all the winners of the World Cup each year.");
	}
	...
	private static void testF1() {
		...
		Integer i = askForInteger("Which match do you want to see? (number)\n",1,matches.getNumberMatches()+1);
		
		System.out.println("\n   * " + matches.getMatch(i-1));
	}

	private static void testF2() {
		
		Integer i = askForInteger("Which is the first match position do you want to see? (number)\n",1,matches.getNumberMatches());
		Integer e = askForInteger("Which is the last match position do you want to see? (number)\n",1,matches.getNumberMatches()+1);
		
		System.out.println("\n   * " + matches.getMatches(i-1,e));
	}
	...
	private static void testF15() {
		
		System.out.println("\n   * " + matches.worldCupWinnerPerYear());
	}
}